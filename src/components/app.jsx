...
const useGameState = () => {
  ...
  const setGameState = (newCanditatesNum) => {
  ...
  return { stars, availableNums, candidates, secondsLeft, setGameState };
};

const Game = (props) => {
  const { stars, availableNums, candidates, secondsLeft, setGameState } =
    useGameState();
